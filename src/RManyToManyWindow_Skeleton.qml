...
RManyToManyWindow_Skeleton-component file for ROneToManyWindow_Skeleton activated by relationship
/many to many
*/
...
ApplicationWindow {
	...
	id:parentW;
	visible:false;
	title:"create a many to many relationship";
	flags:Qt.Dialog;
    ...
    GroupBox { //first groupbox
     ...
     RowLayout { //first row layout starts here
      ...
      Text {text:qsTr("Many"); id:text1; font.pointSize:14; color:"Grey";} //text
